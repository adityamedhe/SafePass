...
<body>
	...
	<div id="content" style="width:55%; min-width:650px;">
		...
		<div id="workspace" align="center" class="tstyle3">	
			...
			<?php
				$imageinfo=getimagesize("../../../imgpasswords/".$_SESSION['uid'].".jpg");
				$width = $imageinfo[0];
				$height = $imageinfo[1];
			?>

			<canvas id="cnv" style="margin-top: 25px;background-image: url(<?php echo '../../../imgpasswords/'.$_SESSION['uid'].'.jpg' ?> );" height="<?php echo $height; ?>" width="<?php echo $width; ?>"> 
			</canvas>		
	...
	function submitPattern()
	{
		...
		$.post("strengthChecker/strengthCheck.php",dataToSend,function(data){
			if(data=='1')
			{
				...
				showDialog("Done!", "Your password has been changed!",0);
			}
			else
			{
