...
<body>
	...
	<div id="content" style="width:55%;">
		...
		<div id="workspace" align="center" class="tstyle3">			
			...
			// if everything is ok, try to upload file
			    ...
			    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
			        ...
			        $query="update users set dp='Y' where id='".$_SESSION['uid']."'";
			        mysql_query($query);
		...
		<div id="footer">		
			...
			{
				echo <<< EOT
				<button class="posbutton" id="but_uname_done" style="float:right;" onclick=window.location='setPass.php'>Done</button>
EOT;
